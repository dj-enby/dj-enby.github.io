...
packwiz modrinth install ears
packwiz modrinth install entityculling
packwiz modrinth install fabric-language-kotlin
packwiz curseforge install farsight-fabric
...
::packwiz modrinth install moreculling fxmorin mods, removing
